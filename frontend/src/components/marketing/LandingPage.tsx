    ...
    <div className="min-h-screen w-full bg-[#0c0c0e] text-[#f4f4f6] flex flex-col overflow-y-auto selection:bg-emerald-500 selection:text-black">
      ...
      <div className="sticky top-0 z-50 pt-5 pb-2 px-4 sm:px-8 w-full max-w-7xl mx-auto pointer-events-none">
        <header className="pointer-events-auto mx-auto w-full rounded-full border border-white/15 bg-[#16161a]/90 backdrop-blur-2xl px-6 sm:px-8 h-20 flex items-center justify-between shadow-2xl shadow-black/60 transition-all">
          ...
          <nav className="hidden md:flex items-center gap-1 text-xs font-bold text-gray-300">
            <a
              href="#showcase"
              className="px-4 py-2 rounded-xl border border-transparent hover:border-white/20 hover:bg-white/[0.08] hover:shadow-[0_0_16px_rgba(255,255,255,0.06)] text-gray-300 hover:text-white transition-all duration-200 flex items-center gap-1.5 cursor-pointer"
            >
              Showcase
            </a>
            ...
            <button
              ...
              className={`px-5 py-2 rounded-xl text-xs font-bold transition-all cursor-pointer border ${
                activeShowcase === "ide"
                  ...
                  : "text-gray-400 hover:text-white border-transparent hover:border-white/20 hover:bg-white/[0.08] hover:shadow-[0_0_16px_rgba(255,255,255,0.06)]"
              }`}
            >
              Split IDE & Preview
            </button>
